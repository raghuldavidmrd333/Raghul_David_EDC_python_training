...
b1=Book(1111,"chronicles of narnia","MRD",200,4)
b2=Book(2222,"harrypotter","Raghul",100,5)
b3=Book(3333,"marvel","SAI",250,3)
b4=Book(4444,"GOT","PRAVEEN",400,2)
l=library()
l.add_book(b1)
print()
l.add_book(b2)
